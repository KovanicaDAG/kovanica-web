...
import { t as require_events } from "./events-BAhvOieP.js";
...
//#endregion
//#region node_modules/@ledgerhq/hw-transport-webusb/lib-es/hid-framing.js
var Tag = 5;
...
//#endregion
//#region node_modules/@ledgerhq/hw-transport-webusb/lib-es/webusb.js
...
async function getLedgerDevices() {
	return (await navigator.usb.getDevices()).filter((d) => d.vendorId === ledgerUSBVendorId);
}
...
//#endregion
//#region node_modules/@ledgerhq/hw-transport-webusb/lib-es/TransportWebUSB.js
...
*/
var TransportWebUSB = class TransportWebUSB extends Transport {
	device;
	deviceModel;
	...
	*/
	static listen = (observer) => {
		...
		getFirstLedgerDevice().then((device) => {
			...
			if (window.DOMException && error instanceof window.DOMException && error.code === 18) observer.error(new TransportWebUSBGestureRequired(error.message));
			else observer.error(new TransportOpenUserCancelled(error.message));
		});
	...
	*/
	static async open(device) {
		...
		if (!iface) throw new TransportInterfaceNotAvailable("No WebUSB interface found for your Ledger device. Please upgrade firmware or contact techsupport.");
