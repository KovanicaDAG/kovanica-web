...
* ```
*/
var hash = (msg) => checkDigest(callHash("sha512")(abytes(msg, void 0, "message")));
...
var _verify = (sig, msg, publicKey, options = defaultVerifyOpts) => {
	...
	const s = bytesToNumberLE(sig.subarray(L, 64));
	let A, R, SB;
...
* ```
*/
var etc = /* @__PURE__ */ Object.freeze({
	bytesToHex,
	hexToBytes,
	concatBytes,
	mod: M,
...
//#endregion
export { Point, etc, getPublicKey, getPublicKeyAsync, hash, hashes, keygen, keygenAsync, sign, signAsync, utils, verify, verifyAsync };
