...
import { H3Event, getRequestHost, toResponse } from "h3-v2";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DaRJOdmA.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./assets/router-bgBdHzxi.js").then((n) => n.t),
...
var server_exports = /* @__PURE__ */ __exportAll({ getRequestHost: () => getRequestHost$1 });
//#endregion
